...
|-----------|-----------|-----------|-----------|-----------|
| PortFolio | [Code](https://github.com/RidhikaJoshi/Portfolio-Latest) | ```NextJs``` ```TypeScript``` ```TailwindCSS``` ```ShadCN UI``` | ```Frontend```| [Website](https://ridhikajoshi.vercel.app/) |
...
| BlogSphere | [Code](https://github.com/RidhikaJoshi/Blog) | ```Appwrite``` ```React``` ```TailwindCSS``` ```AWS S3``` ```Cloudfront```| ```Frontend```|  [Website](https://blog-kappa-ruby.vercel.app/) |
...
|-----------|-----------|
| My Google Interview Experience: A Journey of Hope, Hustle, and Heart | [Link](https://medium.com/@ridhikasmrh/my-google-interview-experience-a-journey-of-hope-hustle-and-heart-7f0144f9de20) | 
| My Microsoft Interview Experience: Insights and Encounters | [Link](https://medium.com/@ridhikasmrh/my-microsoft-interview-experience-insights-and-encounters-73de54b011af) | 
| Embarking on the Desis Ascend Educare Interview Journey | [Link](https://medium.com/@ridhikasmrh/embarking-on-the-desis-ascend-educare-interview-journey-79af19518820) | 
</div>
